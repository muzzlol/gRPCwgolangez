...
type CoffeeShopClient interface {
	...
	PlaceOrder(ctx context.Context, in *Order, opts ...grpc.CallOption) (*Reciept, error)
	GetOrderStatus(ctx context.Context, in *Reciept, opts ...grpc.CallOption) (*OrderStatus, error)
}
...
func (c *coffeeShopClient) PlaceOrder(ctx context.Context, in *Order, opts ...grpc.CallOption) (*Reciept, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Reciept)
...
func (c *coffeeShopClient) GetOrderStatus(ctx context.Context, in *Reciept, opts ...grpc.CallOption) (*OrderStatus, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(OrderStatus)
...
type CoffeeShopServer interface {
	...
	PlaceOrder(context.Context, *Order) (*Reciept, error)
	GetOrderStatus(context.Context, *Reciept) (*OrderStatus, error)
...
func (UnimplementedCoffeeShopServer) PlaceOrder(context.Context, *Order) (*Reciept, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PlaceOrder not implemented")
}
func (UnimplementedCoffeeShopServer) GetOrderStatus(context.Context, *Reciept) (*OrderStatus, error) {
...
func _CoffeeShop_GetOrderStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CoffeeShopServer).GetOrderStatus(ctx, req.(*Reciept))
	}
	return interceptor(ctx, in, info, handler)
}
